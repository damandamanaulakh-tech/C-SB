...
- **SEG-06** → `machine/wiring/BRAIN_ENGINE_OPERATIONAL_SPINE_V1.json`, `raw/human/HUMAN_CONTAINER_SOURCE_SLICE_AV_001.json`, `raw/human/HUMAN_CONTAINER_SOURCE_SLICE_MR_001.json`, `registries/asi/ENGINE_SEGMENT_BINDINGS_75_APPROVED_V1.json`, `registries/asi/OPERATIONAL_CONTAINERS_161_240_APPROVED_V1.json`, `registries/expansion/EXPANSION_CONTAINERS_081_160_INDEX_V1.json`
...
- **SEG-08** → `machine/wiring/BRAIN_ENGINE_OPERATIONAL_SPINE_V1.json`, `raw/human/HUMAN_CONTAINER_SOURCE_SLICE_MR_001.json`, `registries/asi/ENGINE_SEGMENT_BINDINGS_75_APPROVED_V1.json`, `registries/asi/OPERATIONAL_CONTAINERS_161_240_APPROVED_V1.json`, `registries/expansion/EXPANSION_CONTAINERS_081_160_INDEX_V1.json`
...
- **CON-047** → `phase2/reviews/AI_CAPABILITY_MAP_REVIEW_01.md`, `phase2/tests/P2_ACTOR_VIEW_LEAKAGE_FIXTURE_001.json`, `phase2/tests/P2_MULTI_RUBRIC_INTEGRATION_FIXTURE_001.json`, `raw/human/HUMAN_CONTAINER_SOURCE_SLICE_AV_001.json`, `raw/human/HUMAN_CONTAINER_SOURCE_SLICE_MR_001.json`, `raw/rubrics/AI_CAPABILITY_TO_SOURCEBORN_CONTAINERS_REVIEW.md`
...
- **CON-064** → `phase2/tests/P2_MULTI_RUBRIC_INTEGRATION_FIXTURE_001.json`, `raw/human/HUMAN_CONTAINER_SOURCE_SLICE_MR_001.json`, `raw/rubrics/AI_CAPABILITY_TO_SOURCEBORN_CONTAINERS_REVIEW.md`
...
- **ASI-10** → `machine/wiring/BRAIN_ENGINE_OPERATIONAL_SPINE_V1.json`, `phase2/tests/P2_ACTOR_VIEW_LEAKAGE_FIXTURE_001.json`, `registries/ai/AI_ONLY_GOVERNANCE_BINDING_PATCH_V1.json`, `registries/asi/ASI_CONTAINER_CANDIDATES_FROM_AI_SOURCES_V0.json`, `registries/asi/ASI_RUBRIC_V0.json`, `registries/expansion/EXPANSION_103_120_AI_ASI_CLASSIFICATION_V1.json`
