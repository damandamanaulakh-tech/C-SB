...
- **CON-047** → `phase2/reviews/AI_CAPABILITY_MAP_REVIEW_01.md`, `phase2/tests/P2_MULTI_RUBRIC_INTEGRATION_FIXTURE_001.json`, `raw/human/HUMAN_CONTAINER_SOURCE_SLICE_AV_001.json`, `raw/human/HUMAN_CONTAINER_SOURCE_SLICE_MR_001.json`, `raw/rubrics/AI_CAPABILITY_TO_SOURCEBORN_CONTAINERS_REVIEW.md`
...
- **CON-066** → `raw/human/HUMAN_CONTAINER_SOURCE_SLICE_AV_001.json`, `raw/rubrics/AI_CAPABILITY_TO_SOURCEBORN_CONTAINERS_REVIEW.md`
...
- **CON-069** → `raw/human/HUMAN_CONTAINER_SOURCE_SLICE_AV_001.json`, `raw/rubrics/AI_CAPABILITY_TO_SOURCEBORN_CONTAINERS_REVIEW.md`
